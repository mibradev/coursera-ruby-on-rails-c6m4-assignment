...
ActiveRecord::Schema.define(version: 20190511224443) do
  ...
  add_index "tags_things", ["thing_id", "tag_id"], name: "index_tags_things_on_thing_id_and_tag_id", unique: true, using: :btree
